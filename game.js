...
module.exports = class Game {
  constructor() {
    ...
    this.tiles = [];
    this.tiles.push({id:0,l1: 1, l2: 1});
    this.tiles.push({id:1,l1: 1, l2: 2});
    this.tiles.push({id:2,l1: 1, l2: 3});
    this.tiles.push({id:3,l1: 1, l2: 4});
    this.tiles.push({id:4,l1: 1, l2: 5});
    this.tiles.push({id:5,l1: 1, l2: 6});
    this.tiles.push({id:6,l1: 2, l2: 2});
    this.tiles.push({id:7,l1: 2, l2: 3});
    this.tiles.push({id:8,l1: 2, l2: 4});
    this.tiles.push({id:9,l1: 2, l2: 5});
    this.tiles.push({id:10,l1: 2, l2: 6});
    this.tiles.push({id:11,l1: 3, l2: 3});
    this.tiles.push({id:12,l1: 3, l2: 4});
    this.tiles.push({id:13,l1: 3, l2: 5});
    this.tiles.push({id:14,l1: 3, l2: 6});
    this.tiles.push({id:15,l1: 4, l2: 4});
    this.tiles.push({id:16,l1: 4, l2: 5});
    this.tiles.push({id:17,l1: 4, l2: 6});
    this.tiles.push({id:18,l1: 5, l2: 5});
    this.tiles.push({id:19,l1: 5, l2: 6});
    this.tiles.push({id:20,l1: 6, l2: 6});
    this.turn = -1;
